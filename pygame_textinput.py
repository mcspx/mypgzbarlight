...
def demo():
	...
	xcolor = [(0,0,255),(0,0,254),(0,255,0),(255,255,0)]
	TEXTH = 25
	textinput = TextInput(
				font_family='Droid Sans Mono',
				font_size=TEXTH, 
				text_color=xcolor[0],
				cursor_color=xcolor[1])
	...
	while True:
		...
		# text frame
		xrect1 = pygame.Rect(10,10,DW-20,TEXTH)
		pygame.draw.rect(display, xcolor[3], xrect1)	
